...
食材の相性ルール：
・甘い果物は主菜、炒め物、サンドイッチ、スープ、煮物に混ぜないでください。
・果物を使う場合は、デザート、付け合わせ、ヨーグルトなどとして扱ってください。
・ブルーベリー、いちご、バナナ、りんご、みかんなどの果物を、肉、魚、きのこ、チーズ、トマト、卵と無理に組み合わせないでください。
・味の方向性が合わない食材は使わないでください。
・甘い、酸っぱい、塩辛い、苦い、脂っこい味が不自然に混ざる料理は避けてください。
